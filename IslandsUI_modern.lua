...
-- Farming Tab
local FarmingSection = Tabs.Farming:AddSection("Farming")

FarmingSection:AddToggle({
    Title = "Auto Farm",
    Description = "Automatically farm nearby crops",
    Default = false,
...
-- Teleport Tab
local TeleportSection = Tabs.Teleport:AddSection("Quick Teleports")
